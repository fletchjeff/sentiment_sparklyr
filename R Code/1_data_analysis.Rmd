...
---
This R Notebook will show one way for working out which of the Simpsons 
characters is the happiest based on analysing the sentiment of their dialogue 
from the show. This is more about showing the process than being as accurate as 
possible, but going through the list at the end, I'm happy with the outcome. 
...
#### Explode that word lists into a single column of word by characters, then find the top 30 characters by number of words.
```{r}
